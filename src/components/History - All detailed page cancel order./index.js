import { View, Text, Image,Seperator, ScrollView } from 'react-native'
...
const HistoryCancel = () => {
  ...
  <View style={{flex: 1, height: 1, backgroundColor: 'black'}} />
      ...
      <View style={{marginVertical:20}}>
        ...
        <Text style={{color:"black",marginVertical:10}}>238 allahabad street ,sanitorium,chennai</Text>
      </View>
      </View>

      <View>
        <Text style={{backgroundColor:"#E6E6E6",textAlign:"center",padding:25,fontSize:22,color:"black"}}>Mail Invoice</Text>
      </View>
